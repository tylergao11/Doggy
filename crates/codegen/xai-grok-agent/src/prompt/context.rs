...
/// Default identity on trim-tool-descriptions (`You are Doggy…`).
pub const DEFAULT_SYSTEM_PROMPT_LABEL: &str = "Doggy";
...
mod tests {
    ...
    fn test_agents_md_paths_use_display_cwd_in_rendered_section() {
        ...
        let overlay_path = "/root/.Doggy/worktrees/my-project/ab-123-a-overlay";
