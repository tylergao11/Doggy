...
/// One Doggy audit finding for `GoalUpdated.completion_findings`.
...
pub enum SessionUpdate {
    ...
    GoalUpdated {
        ...
        /// Doggy completion-gate phase: `executing` | `checking` | `auditing`
        /// | `fixing` | `done` | `paused`. Absent on pre-Doggy shells /
        /// non-goal updates — pager hides the completion chip segment.
        #[serde(default, skip_serializing_if = "Option::is_none")]
        completion_phase: Option<String>,
        /// Structured audit findings for the Doggy completion gate
