...
//!
//! **Doggy completion authority:** this module does **not** decide TaskDone.
//! Nudges may inject follow-up prompts for UX/telemetry, but the sole
//! completion gate is `run_doggy_round_end` + audit pass
//! (`docs/编排/完成权.md`). Premature-stop regex similarly only flavors
//! legacy continuation text when tests call `maybe_queue_goal_continuation`.
