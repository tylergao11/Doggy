...
// Doggy: legacy goal e2e/backoff suites that pinned old completion semantics
// (completed→Complete, maybe_queue dual-path) were deleted. Completion
// authority is covered by `xai-doggy-orchestrator` unit tests + doggy_gate.
#[cfg(test)]
