...
/// Doggy completion-gate phase (orthogonal to planner `GoalDisplayPhase`).
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub enum GoalCompletionPhase {
    Executing,
    Checking,
    Auditing,
    Fixing,
...
impl GoalCompletionPhase {
    ...
    /// Short chip / modal label.
    pub fn label(self) -> &'static str {
        match self {
            Self::Executing => "Working",
            Self::Checking => "Checking",
            Self::Auditing => "Auditing…",
            Self::Fixing => "Needs fixes",
            Self::Done => "Done",
            Self::Paused => "Paused",
        }
    }
...
pub struct GoalDisplayState {
    ...
    pub planning: bool,
    /// Doggy completion gate phase, when the shell reports it.
