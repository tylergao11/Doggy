...
//! file logger that writes to `~/.Doggy/logs/memory.log`.
//!
//! ## When to use
//!
...
//! tail -f ~/.Doggy/logs/memory.log      # watch in another terminal
//! ```
...
mod inner {
    ...
    ///
    /// Writes to `~/.Doggy/logs/memory.log`. Filters to `xai_memory=trace`.
